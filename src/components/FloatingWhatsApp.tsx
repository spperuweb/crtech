...
export default function FloatingWhatsApp({ currentRoute }: FloatingWhatsAppProps) {
  ...
  return (
    <a
      ...
      aria-label="Hablar por WhatsApp con un especialista de CR Tech"
    >
      <svg
      ...
      <span className="floating-whatsapp-text desktop-text">Hablar por WhatsApp</span>
      <span className="floating-whatsapp-text mobile-text">WhatsApp</span>
    </a>
  );
}
